...
do
    ...
    do
        ...
        OUTPUT=`mpirun -np $process --hostfile mpi-hosts ./border_detection input_images/$size.jpg output_images/grayscale_$size.jpg output_images/$size.jpg $filter_intensity $process`
        echo -e ${OUTPUT}
